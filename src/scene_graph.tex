...
Il paper fornisce i modelli PSGFormer e PSGTr in diverse configurazioni: Backbone ResNet-50 e ResNet-101 e modelli addestrati in 12 e 60 epoche. Per il nostro caso d'uso abbiamo scelto PSGTr in versione \textbf{ResNet-50 addestrato in 60 epoche} poiché è quello che ha ottenuto i risultati migliori per la generazione del grafo di scena, considerandosi \textbf{Stato dell'Arte}.\\\\
\begin{table}[H]
  \centering
  \resizebox{\textwidth}{!}{
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{scene_graph/pq-comparison.png}
