...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption{Camera Frustum. I vertici del piano blu rappresentano la proiezione degli estremi del frame nel sistema di coordinate camera. I vertici del piano verde rappresentano la proiezione degli estremi del frame nel sistema di coordinate mappa.}
\end{figure}\\
